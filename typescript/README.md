# Grid Point Code (GPC) for TypeScript
...
GPC.fromInteger(50180843496709);               // '#G3RJM-98NM9'
```
...
GPC.isValidCoordinates(91, 0);           // [false, 'LATITUDE']
```

`encode` throws for a coordinate outside the domain. When you would rather ask
